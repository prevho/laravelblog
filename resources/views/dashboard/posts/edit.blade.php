    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto p-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <x-form action="{{ route('posts.update', $post->slug) }}" has-files method="put">
                    ...
                    <div class="mt-5">
                        ...
                        <img src="{{url('storage/blog_images', $post->image)}}" class="img-fluid w-20" alt="">
                    ...
                    <div class="mt-5">
                        ...
                        <x-trix name="description" styling="overflow-y-scroll h-40" value="">{{ $post->description }}</x-trix>
